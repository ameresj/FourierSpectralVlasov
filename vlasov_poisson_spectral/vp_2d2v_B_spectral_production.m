...
splitting='shear'; % shear std imr scovel scovel_imr

for splitting_order={'strang'} %, '2nd4lie', 'fourth10lie'}
    splitting_order=splitting_order{1};
for splittings={'scovel','std'} %'shear','scovel_imr','imr' 
    splitting=splittings{1};
    for B3=[1,2,4,8,16,32]
